...
//           <PageHeader>{this.props.podcast.title}</PageHeader>
//           <Grid>
//             <Row>
//               <Col xs={12} md={4}>
//                 <div className="logo"><img src={this.props.podcast.image} style={{height: 140, width: 140}}/></div>
//                 <div>
//                   <p><b>Machine Learning Guide</b> {this.props.podcast.body}</p>
